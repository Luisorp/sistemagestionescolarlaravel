                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="">Logo de la institución</label>
                                    ...
                                    name="logo" placeholder="Escriba aquí..." onchange="mostrarImagen(event)" accept="image/*">
                                      <br>
                                <center>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        @error('descripcion')
                                        <small style="color: Dred">{{$message}}</small>
                                        @enderror
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control" value="{{ old('direccion', $configuracion->direccion ?? '') }}" name="direccion" placeholder="Escriba aqui ... " required>
                                        </div>
                                        @error('direccion')
                                        <small style="color: Dred">{{$message}}</small>
                                        @enderror
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('telefono', $configuracion->telefono ?? '') }}" name="telefono" placeholder="Escriba aquí...">
                                        </div>
                                        @error('telefono')
                                        <small style="color: Dred">{{$message}}</small>
                                        @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="correo_electronico" class="form-control" value="{{ old('correo_electronico', $configuracion->correo_electronico ?? '') }}" name="correo_electronico" placeholder="Escriba aquí..." required>
                                    </div>
